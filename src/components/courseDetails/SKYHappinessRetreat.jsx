              ...
              <div className="row">
                ...
                >
                  <div className="logo-achivment">
                    ...
                    <p className="achivment__text">
                      live interactive sessions with 1000 hour trained certified
                      instructors
                    </p>
                  </div>
                </div>
                  ...
                  <div className="col-12 col-lg-3 text-center text-lg-left mt-4 mt-lg-0">
                    <div className="logo-achivment">
                      ...
                      <p className="achivment__text">
                        ...
                        <span className="discount">${delfee}</span> and is
                        currently offered at a reduced rate for students with a
                        valid .edu email
                      </p>
                    </div>
                  </div>
