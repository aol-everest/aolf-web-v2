...
import { tConvert, phoneRegExp, parsedAddress, isEmpty } from '@utils';
import {
...
export const PaymentFormCheckoutNew = ({
  workshopMaster,
  workshop,
  courseType,
  activeStep,
  ...
  const completeEnrollmentAction = async (values) => {
    ...
    try {
      ...
      await processPayment(values, payLoad, isPaymentRequired);
    } catch (ex) {
      console.error(ex);
      ...
      track('show_error', {
        screen_name: 'course_checkout_error',
