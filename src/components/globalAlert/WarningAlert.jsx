    ...
    >
      <div
        className={classNames(
          'tw-fixed tw-left-4 tw-right-4 md:tw-right-auto md:tw-left-4 tw-bottom-4 tw-bg-white tw-rounded-lg tw-shadow-lg tw-border tw-border-yellow-100 md:tw-max-w-sm tw-w-auto',
          className,
        )}
      >
