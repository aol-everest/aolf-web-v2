    ...
    <>
      <div className="journey-starts__step">
        ...
        <div className="journey-starts__detail">
          ...
          <p className="journey-starts__step-text">
            It’s a great time to clear some blocks on your calendar for your
            retreat. Get ready to drop stress, recharge your batteries, and
      ...
      <div className="journey-starts__step">
        ...
        <div className="journey-starts__detail">
          ...
          <p className="journey-starts__step-text">
            Feel free to bring a water bottle and a yoga mat if you wish. Dress
            comfortably for some light stretching and meditation.
          </p>
        </div>
      </div>
      <div className="journey-starts__step">
