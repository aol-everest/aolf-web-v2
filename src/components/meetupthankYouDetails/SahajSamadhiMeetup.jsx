export const SahajSamadhiMeetup = () => {
  return (
    <>
      <div className="journey-starts__step">
        ...
        <div className="journey-starts__detail">
          ...
          <p className="journey-starts__step-text">
            Please arrive 5 minutes early to get settled. This is your time to
            drop stress, recharge your batteries, and re-align with your inner
            truth.
          </p>
        </div>
      </div>
      <div className="journey-starts__step">
        ...
        <div className="journey-starts__detail">
          ...
          <p className="journey-starts__step-text">
            ...
            Prepare to join with like-minded seekers and unlock the power of
            meditating together.
          </p>
        </div>
      </div>
