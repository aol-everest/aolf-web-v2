...
function SvgIcPlay(props) {
  return (
    ...
    >
      <defs>
        <linearGradient id="ic-play_svg__c" x1="50%" x2="50%" y1="100%" y2="0%">
        ...
        <circle id="ic-play_svg__b" cx={30} cy={30} r={30} />
      </defs>
      <g fill="none" fillRule="evenodd">
        <use
          fill="#000"
          filter="url(#ic-play_svg__a)"
          xlinkHref="#ic-play_svg__b"
        />
        <use fill="#FFF" xlinkHref="#ic-play_svg__b" />
        <rect width={60} height={60} fill="url(#ic-play_svg__c)" rx={30} />
        <path
          fill="#FFF"
          fillRule="nonzero"
