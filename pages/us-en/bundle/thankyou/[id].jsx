              ...
              <div className="journey__benefits">
                <div className="journey__benefit benefit-journey">
                  ...
                  <p className="benefit-journey__description">
                    ...
                    Before the session begins, you will receive your Zoom
                    meeting ID and password in your welcome email.
                  </p>
                </div>
                ...
                <div className="journey__benefit benefit-journey">
                  ...
                  <p className="benefit-journey__description">
                    We’ll be meeting on zoom. If you do not already have it, you
                    can download zoom{' '}
                    <a
