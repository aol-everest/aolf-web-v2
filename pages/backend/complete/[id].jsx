                            ...
                            <>
                              ...
                              <div className="col-sm-12">
                                ...
                                <p className="alrtCondi tw-mt-4">
                                  For any health related questions, please
                                  contact us at{" "}
        ...
        {!validRequest && (
          <div className="row">
            <div className="col-md-12 col-sm-12 col-xs-12">
              <div className="error-alert cupon_card card sweet-alert">
                ...
                <div className="card-body">
                  <h2 className="enjoy_text">{"Request is invalid."}</h2>
                  <div className="text-muted lead">
                    Backend registeration request is invalid. please check
                    workshop id and try again.
                  </div>
                </div>
              </div>
            </div>
